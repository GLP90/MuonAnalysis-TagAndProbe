...
if len(args) > 1: 
    data_sample = args[1]
print 'data sample is', data_sample 
id_bins = '1'
if len(args) > 2: 
    id_bins = args[2]
...
if scenario == 'data_all':
    if data_sample == '25ns':
        ...
        process.TnP_MuonID = Template.clone(
            InputFileNames = cms.vstring(
                'root://eoscms//eos/cms/store/group/phys_muon/TagAndProbe/TnP_trees_aod747_25ns_goldenJSON_254790-254879.root',
                ),
    ...
    process.TnP_MuonID = Template.clone(
        InputFileNames = cms.vstring(
            'root://eoscms//eos/cms/store/group/phys_muon/perrin/Ischia/SmallTree_TnP_trees_aod747_DY_LOmadgraph_25ns_withFixes_withNVtxWeights.root'
            ),
        InputTreeName = cms.string("fitter_tree"),
        InputDirectoryName = cms.string("tpTree"),
        OutputFileName = cms.string("TnP_MuonID_%s.root" % scenario),
